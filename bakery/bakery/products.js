document.addEventListener("DOMContentLoaded", () => {
  ...
  const productInitials = document.getElementById("productInitials")
  ...
  function openEditProductModal(product) {
    ...
    productInitials.textContent = initials.toUpperCase();
  ...
  saveEditProduct.addEventListener("click", () => {
    if (currentEditProduct) {
      ...
      // Find and update the product in the data array
      const index = productsData.findIndex(p => p.id === currentEditProduct.id);
      if (index !== -1) {
